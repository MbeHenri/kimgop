        ...
        child: Center(
          child: Wrap(
            children: [
              ...
              errorState == 1
                  ? const Text(
                      "L'étiquete est existant, choisissez en un autre",
              ...
              Row(
                children: [
                  TextButton(
                      onPressed: () async {
                        //on renvoie le titre qui a été entré par l'utilisateur si la table existe déja
                        if (controleurTitre.text != "") {
                          if (widget.titre == null) {
                            ...
                            if (database != null) {
                              try {
                                database.execute(
                                    "INSERT INTO table_recommandation (etiquete) values ('${controleurTitre.text}');");
                                database.execute(
