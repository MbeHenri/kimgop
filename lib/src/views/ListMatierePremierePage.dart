          ...
          return Dismissible(
              ...
              onDismissed: (direction) async {
                ...
                if (database != null) {
                  ...
                  database.execute(
                      "DELETE FROM composition_mt WHERE idMtP=${tabs[index].id}");
                  database.execute(
                      "DELETE FROM contenu_chimique WHERE idMtP=${tabs[index].id}");
                  updateList();
                }
          ...
          child: Wrap(
            children: [
              ...
              SwitchListTile(
                  ...
                  title: const Text(" Matiere courante ?"),
                  value: isdefault,
