...
class _ListCarChimiquePageState extends State<ListCarChimiquePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: tabs.isEmpty
          ? const Center(
              child: Text("aucunes matieres premieres n'est pris en charge"))
          : listCar(),
        ...
        child: Form(
          child: Wrap(
            children: [
              ...
              errorState == 1
                  ? const Text(
                      "Le nom ou l'abréviation ont déja été utilisé, choisissez en d'autre",
                      style: TextStyle(color: Colors.redAccent, fontSize: 12))
                  : errorState == 2
                      ? const Text("Le nom ou l'abréviation sont invalides",
                          style:
              ...
              SwitchListTile(
                  ...
                  title: const Text(" Axe d'analyse ?"),
                  value: isdefault,
